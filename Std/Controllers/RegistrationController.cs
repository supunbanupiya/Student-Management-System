...
namespace Std.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.id = new SelectList(db.registrations, "id", "lastname");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
            ...
            ViewBag.firstnameList = new SelectList(db.registrations, "id", "firstname");
            ViewBag.lastnameList = new SelectList(db.registrations, "id", "lastname");
            return View(registration);
        }
        ...
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
            ...
            ViewBag.id = new SelectList(db.registrations, "id", "lastname", registration.id);
            return View(registration);
        }
